...
exports.isEvalError = function (value) {
    return objectToString(value) === '[object Error]' && value.constructor.name === 'EvalError';
};

exports.isPlainError = function (value) {
    return objectToString(value) === '[object Error]' && value.constructor.name === 'Error';
};

exports.isRangeError = function (value) {
    return objectToString(value) === '[object Error]' && value.constructor.name === 'RangeError';
};

exports.isReferenceError = function (value) {
    return objectToString(value) === '[object Error]' && value.constructor.name === 'ReferenceError';
};

exports.isSyntaxError = function (value) {
    return objectToString(value) === '[object Error]' && value.constructor.name === 'SyntaxError';
};

exports.isTypeError = function (value) {
    return objectToString(value) === '[object Error]' && value.constructor.name === 'TypeError';
};

exports.isURIError = function (value) {
    return objectToString(value) === '[object Error]' && value.constructor.name === 'URIError';
};
