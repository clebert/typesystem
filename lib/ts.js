...
ts.isInt8 = function (value) {
    return ts.isInt(value) && isInRange(value, 0x7f, -0x80);
};

ts.isInt16 = function (value) {
    return ts.isInt(value) && isInRange(value, 0x7fff, -0x8000);
};

ts.isInt32 = function (value) {
    return ts.isInt(value) && isInRange(value, 0x7fffffff, -0x80000000);
};

ts.isUInt = function (value) {
    return ts.isInt(value) && value >= 0;
};

ts.isUInt8 = function (value) {
    return ts.isInt(value) && isInRange(value, 0xff, 0);
};

ts.isUInt16 = function (value) {
    return ts.isInt(value) && isInRange(value, 0xffff, 0);
};

ts.isUInt32 = function (value) {
    return ts.isInt(value) && isInRange(value, 0xffffffff, 0);
};
